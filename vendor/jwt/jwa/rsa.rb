...
# await: true
#
# homura patch: adapted from ruby-jwt v2.9.3 rsa.rb.
  ...
  module JWA
    class Rsa
      ...
      def sign(data:, signing_key:)
        ...
        # homura patch: `.__await__` — subtle-backed sign returns Promise.
        signing_key.sign(digest, data).__await__
      end

      def verify(data:, signature:, verification_key:)
        # homura patch: `.__await__` — subtle-backed verify returns Promise.
