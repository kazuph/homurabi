...
| [`ai-voice-chat/`](ai-voice-chat/) | Sinatra + Workers AI (Whisper + Kimi K2.6 + Aura) | <https://ai-voice-chat.kazu-san.workers.dev/> *(token required)* | Full voice round-trip: audio upload, transcript, Kimi reply, romaji rewrite for Japanese TTS, and inline MP3 playback from `ai.speak_data_url`. |
