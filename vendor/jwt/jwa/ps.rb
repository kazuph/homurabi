...
# await: true
#
# homura patch: adapted from ruby-jwt v2.9.3 ps.rb. Phase 7 RSA-PSS hits
  ...
  module JWA
    class Ps
      ...
      def sign(data:, signing_key:)
        ...
        # homura patch: `.__await__`. salt_length: :digest is fixed here
      ...
      def verify(data:, signature:, verification_key:)
        # homura patch: `.__await__`. salt_length: :digest (see sign).
