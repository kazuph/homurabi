...
module Opal
  module Rewriters
    class JsReservedWords < Base
      ...
      # `@prototype = nil` at class-body time, which corrupts the class.
      PROTO_SPECIAL_PROPS = /#{REGEXP_START}(?:constructor|displayName|prototype|__proto__|__parent__|__noSuchMethod__|__count__)#{REGEXP_END}/.freeze
