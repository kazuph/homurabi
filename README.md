...
|---|---|---|---|
| **Opal** (Ruby→JS compiler + corelib + stdlib) | `1.8.3.rc1.1` (homura fork; based on upstream `1.8.3.rc1`) | `vendor/opal-gem/` | <https://github.com/opal/opal> |
...
├── vendor/
│   ├── opal-gem/                ← Opal fork 1.8.3.rc1.1 (based on upstream 1.8.3.rc1).
