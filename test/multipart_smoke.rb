...
MultipartSmoke.assert("UploadedFile#to_uint8_array yields correct bytes") do
...
MultipartSmoke.assert("empty filename is treated as an empty text value") do
  b = "B5"
...
MultipartSmoke.assert("graceful empty-return for non-multipart CT") do
...
MultipartSmoke.assert("64 KiB binary body survives parsing intact") do
  b = "B13"
